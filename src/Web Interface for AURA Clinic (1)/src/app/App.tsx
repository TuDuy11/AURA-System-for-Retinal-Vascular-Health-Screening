<<<<<<< HEAD:src/Web Interface for AURA Clinic (1)/src/app/App.tsx
...
type ViewMode = 'website' | 'login' | 'register' | 'forgot-password' | 'reset-password' | 'dev-notes';
...
export default function App() {
  ...
  if (typeof window !== 'undefined') {
    (window as any).showDevNotes = () => setViewMode('dev-notes');
  ...
  const handleLogin = (role: 'doctor' | 'patient', id: string, response: LoginResponse) => {
    setUserRole(role);
    setUserId(id);
...
export default function App() {
  ...
  const handleLogin = (
    ...
    setLoginResponse(response);
    setViewMode("website");
>>>>>>> efcb8ba60e63834eb9db130be1617615df418b0d:src/frontend/src/app/App.tsx
  };
...
<<<<<<< HEAD:src/Web Interface for AURA Clinic (1)/src/app/App.tsx
  ...
  if (viewMode === 'reset-password') {
    return <ResetPasswordPage email={resetEmail} onResetSuccess={handleResetSuccess} onBackToLogin={backToLogin} />;
  }

  // Show forgot password page
  if (viewMode === 'forgot-password') {
    return <ForgotPasswordPage onBackToLogin={backToLogin} onResetLinkSent={handleResetLinkSent} />;
  }

  // Show register page
  if (viewMode === 'register') {
    return <RegisterPage onBackToLogin={backToLogin} onRegisterSuccess={handleLogin} />;
  }
